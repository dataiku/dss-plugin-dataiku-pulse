...
class MyRunnable(Runnable):
    ...
    def data_gather(self, project_keys):
        ...
        for key in project_keys:
            ...
            results += dss_funcs.run_modules(self, dss_objs, project_handle, self.client_d, key)
    ...
    def run(self, progress_callback):
        ...
        if self.do_parallel:
            ...
            dfs = Parallel(n_jobs=self.cores)(delayed(self.data_gather)(project_keys) for project_keys in pk_arrays)

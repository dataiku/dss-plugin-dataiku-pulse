META = {
    "id": "users.viewing_last_login_recency",
    "version": 1,
    "label": "Viewing Users — Last Login Recency",
    "description": "Recency of last login for users performing viewing activities",
    "type": "graph",
    "tab": "activity",
    "graph": {
        "kind": "bar",

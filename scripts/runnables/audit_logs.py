...
def _maybe_reexec_with_pulse_env() -> None:
    ...
    Allows running:
      python scripts/runnables/audit_logs.py

    Instead of requiring:
      /home/dataiku/workspace/project-lib-versioned/python/dataiku-pulse.extras/plugin_dataiku-pulse_managed/bin/python scripts/runnables/audit_logs.py
    """
